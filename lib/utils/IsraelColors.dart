...
import 'package:go_for_israel/utils/HexColor.dart';
...
class IsraelColors{
  ...
  static Color profileItemMenuColor = HexColor("#8cc3f8");
  static Color headlinesAgenda = HexColor("#2699fb");
  static Color textDstsAgenda = HexColor("#5a6366");
  static Color lineAgenda = HexColor("#bce0fd");
  static Color sheduleColoLight = HexColor("#f1f9ff");
